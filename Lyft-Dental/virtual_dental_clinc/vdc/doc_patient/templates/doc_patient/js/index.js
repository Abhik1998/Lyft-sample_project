...
$(window).load(function() {
  chat_id=(window.location.href).split("/",6)[5]
  myName = ((window.location.href).split("/",6)[4]).split("%")[0]
  $messages.mCustomScrollbar();

  firebase.database().ref("chat").child(chat_id).child("messages").on("child_added", function (snapshot) {
